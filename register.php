...
<html lang="en">
    <head>
        ...
        <title>Register - EMS Admin</title>
                                    ...
                                    <div class="card-body">
                                        <form action="" method="post">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="contact_no" id="contact_no" type="text" placeholder="8801*********" />
                                        ...
                                        <?php
                                            if($_POST){
                                                ...
                                                unset($_POST['cpassword'],$_POST['first_name'],$_POST['last_name']);
